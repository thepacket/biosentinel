...
- ✅ **In-vitro CRISPR-Dx designer (`/diagnostics`)** — DETECTR/SHERLOCK detection crRNAs + RPA pre-amplification primers; legacy assays load as examples; `biosensor.ts` adapted from CRISPR Studio
